...
void datum(char* sztring)//kézbesítés idejének ellenőrzött beviteléhez szükséges fv. ha a dátum hibás, vagy jövőbeli dátum, vagy 1900 előtti dátum, hibát ír ki
{
   time_t timeval;
   struct tm *tp;
   time (&timeval);
